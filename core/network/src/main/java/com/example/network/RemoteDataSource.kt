...
sealed interface RemoteDataSource {
    ...
    suspend fun getDonationRequests(): Result<List<com.example.model.app.DonationRequestView>>
    ...
    suspend fun getUserTransactions(id: String): Result<List<com.example.model.app.TransactionView>>
